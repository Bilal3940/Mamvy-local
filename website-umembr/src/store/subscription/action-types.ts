...
export const GET_PAYMENT_METHOD: string = 'GET_PAYMENT_METHOD';
export const GET_PAYMENT_METHOD_ASYNC: string = 'GET_PAYMENT_METHOD_ASYNC';

export const UPDATE_PAYMENT_METHOD: string = 'UPDATE_PAYMENT_METHOD';
export const UPDATE_PAYMENT_METHOD_ASYNC: string = 'UPDATE_PAYMENT_METHOD_ASYNC';

export const FETCH_LATEST_INVOICE = 'FETCH_LATEST_INVOICE';
export const FETCH_LATEST_INVOICE_ASYNC = 'FETCH_LATEST_INVOICE_ASYNC';
