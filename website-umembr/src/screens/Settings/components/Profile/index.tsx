                      ...
                      endAdornment: (
                        <InputAdornment position='end'>
                          <MuiButton
                            type='button'
                            variant='contained'
                            disabled={editableField === 'name' && !!errors.name}
                            method={() => {
                      ...
                      endAdornment: (
                        <InputAdornment position='end'>
                          <MuiButton
                            type='button'
                            variant='contained'
                            disabled={editableField === 'lastname' && !!errors.lastname}
                            method={() => {
                              const hasErrors = Object.values(errors).some((error) => !!error);
                        ...
                        <InputAdornment position='end'>
                          <MuiButton
                            ...
                            disabled={
                              ...
                              Object.values(errors).some((error) => !!error && editableField !== 'password')
                            }
                            method={() => {
                              const hasErrors = Object.values(errors).some((error) => !!error);
                            ...
                            <Typography color={palette?.primary} sx={{ textDecoration: 'underline' }} variant='button'>
                              {editableField === 'password' ? 'Save' : 'Change'}
                            </Typography>
                          </MuiButton>
                          <IconButton sx={{ marginBottom: '1rem' }} onClick={switchShowPassword} edge='end'>
                            <Image
                  ...
                  {user.isSubscriber ? (
                    <>
                      <Typography
                        ...
                        fontSize={'1rem'}>
                        <a onClick={manageSub}>Manage subscription</a>
                      </Typography>
                      <Typography
